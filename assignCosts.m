...
function [decided_costs] = assignCosts(...
  ...
  time_from, n_tsteps, from_state_map, to_state_map, power_demand, heat_demand, ...
  elec_tariff, heat_tariff, price_kg_f, transition_penalty)
...
% global av_P_demand
% global av_H_demand
% global av_P_produced
% global av_H_produced
...
%% lambda: Anoop
%av_lambda=(lambda(t)+lambda(t+1)), lambda=[lambda_p lambda_h] - do both
%at the same time
%  av_lambda=(...
...
%  av_subgradient_lambda_p = av_P_produced - av_P_demand;
%  av_subgradient_lambda_h = av_H_produced - av_H_demand;
...
elec_cost = bsxfun(@times, ...
  ...
  * dt * joule2kWh;%% What is this cost?
